...
const (
	ARK_APP_DEFAULT AppType = iota // none
...
const (
	ARK_APP_CLUSTER_MAX AppType = iota + 29 // max of cluster
...
const (
	ARK_APP_WORLD_MAX AppType = iota + 199 // max of world
	ARK_APP_REDIS                          // Redis server // others start
	ARK_APP_MYSQL                          // MySQL server
)

const (
	ARK_APP_MAX AppType = 255 // max of all processes
)
